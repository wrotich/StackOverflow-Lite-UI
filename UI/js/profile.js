...
window.addEventListener('load', fetchUserQuestions);
function fetchUserQuestions() { 
    fetch('https://stackoverflow-lite-ch3.herokuapp.com/api/v1/questions/user', {
        method: 'GET',
        mode:'cors',
        ...
        'Authorization':'Bearer '+ window.localStorage.getItem('auth_token')},
          ...
          .then((data) => {
            ...
            document.getElementById('user_questions').innerHTML=all_questions.join('')
            }
            if (http_code == 401){
                alert(data.Message)
            }
